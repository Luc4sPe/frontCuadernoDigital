...
export class AsesoriaRiegoAgroPorProductorComponent implements OnInit {
  ...
  exportarPdf(){
    ...
    // configuracion de la tabla asesoría riego
   
      var columns = [
        { title: "Finca", dataKey: "finca" },
        { title: "Cuadro", dataKey: "cuadro" },
        { title: "Duración", dataKey: "duracionEnHoras" },
        { title: "Milimetros aplicados", dataKey: "milimetrosAplicados" },
        { title: "Fecha estimada", dataKey: "fechaEstimadaAplicacionParsed" },
        { title: "Fecha aplicada", dataKey: "fechaAplicacionAsesoria" },
        { title: "Encargado agrícola", dataKey: "nombreEncargado" }
      ];
    
      var rows = [];
    
      this.asesoriaRiego.map(function (r) {
        var fechaEstimada = new Date(r.fechaEstimadaAplicacionParsed);
        var fechaDeAplicacion = new Date(r.fechaAplicacionAsesoria);
        rows.push({
          finca: r.finca.nombre,
          cuadro: r.cuadro.numeroCuadro,
          duracionEnHoras: r.duracionEnHoras,
          milimetrosAplicados: r.milimetrosAplicados,
          fechaEstimadaAplicacionParsed: fechaEstimada.toLocaleDateString(),
          fechaAplicacionAsesoria: fechaDeAplicacion.toLocaleDateString(),
